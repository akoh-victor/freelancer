...
class AdvertType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('title', 'text', array('label' => 'Title','attr' => array('class'=>'form-control')))
            ->add('advertiser', 'text', array('label' => 'Advertiser','attr' => array('class'=>'form-control')))
            ...
            ->add('displayLocation','choice',array(
                ...
                'choices' => array('index' => 'Homepage', 'department' => 'Department','category'=>'Category',
                    'all'=>'All location',
                    'group'=>'Group'),
